...
var iconSearch = document.querySelector(
  ".header-menu .right-block .search-icon"
);
var searchBlock = document.querySelector(".header-menu .search-block");
var iconCloseSearch = document.querySelector(
  ".header-menu .search-block .icon-close"
);
if (iconSearch) {
...
var menuMobileMain = document.querySelector(
  "#menu-mobile-block .menu-mobile-main"
);
...
var animateTextSlider = function animateTextSlider() {
  var sliderActive = document.querySelector(
    ".slider-block .slick-list .slick-active"
  );
...
var prevArrow = document.querySelector(
  ".slider-block.animation-one .prev-arrow"
);
var nextArrow = document.querySelector(
  ".slider-block.animation-one .next-arrow"
);
if (prevArrow) {
...
var animateTextSlider3 = function animateTextSlider3() {
  ...
  var listFeatureActive = sliderActive.querySelector(
    ".text-content .list-feature"
  );
  var blockBtnActive = sliderActive.querySelector(
    ".text-content .block-button"
  );

  // Get the elements in text content
  var textHeadings = document.querySelectorAll(
    ".slider-item .text-content .heading1"
  );
  var textBodys = document.querySelectorAll(
    ".slider-item .text-content .body2"
  );
  var listFeatures = document.querySelectorAll(
    ".slider-item .text-content .list-feature"
  );
  var blockBtns = document.querySelectorAll(
    ".slider-item .text-content .block-button"
  );
    ...
    characters.forEach(function (_char, index) {
      ...
      if (index < 4) {
        span.classList.add(
          "animate__animated",
          "animate__fadeIn",
          "animate__delay-0-".concat((index + 1) * 2, "s")
        );
      }
      if (index >= 4 && index < 9) {
        span.classList.add(
          "animate__animated",
          "animate__fadeIn",
          "animate__delay-1-".concat(((index + 1) * 2) % 10, "s")
        );
      }
      if (index >= 9 && index < 14) {
        span.classList.add(
          "animate__animated",
          "animate__fadeIn",
          "animate__delay-2-".concat(((index + 1) * 2) % 20, "s")
        );
      }
      if (index >= 14) {
        span.classList.add(
          "animate__animated",
          "animate__fadeIn",
          "animate__delay-3-".concat(((index + 1) * 2) % 30, "s")
        );
      }
  ...
  if (listFeatureActive) {
    listFeatureActive.classList.add(
      "animate__animated",
      "animate__fadeInUp",
      "animate__delay-1-5s"
    );
...
var prevArrow3 = document.querySelector(
  ".slider-block.animation-two .prev-arrow"
);
var nextArrow3 = document.querySelector(
  ".slider-block.animation-two .next-arrow"
);
if (prevArrow3) {
...
$(".slider-block.animation-two .list-slider").on(
  "swipe",
...
var listSlideItem = document.querySelectorAll(
  ".section-slide-shared .slick-list"
);
...
var dots = document.querySelectorAll(
  ".section-testimonial.style-one .testimonial-item .slick-dots li"
);
var listAvatar = document.querySelector(
  ".section-testimonial.style-one .list-avatar"
);
var avatar = document.querySelectorAll(
  ".section-testimonial.style-one .list-avatar .bg-img"
);
var changeAvatarTestimonial = function changeAvatarTestimonial() {
  avatar.forEach(function (item) {
    ...
    var testimonialCurrent = document.querySelector(
      ".section-testimonial.style-one .testimonial-item .slick-current"
    );
...
// Execute the function that creates the effect after dragging the slide
$(".section-testimonial.style-one .testimonial-item").on(
  "swipe",
  function (event, slick, currentSlide) {
    changeAvatarTestimonial();
  }
...
var listTestimonials = document.querySelectorAll(
  ".section-testimonial-shared .slick-list"
);
...
var textBoxCircle = document.querySelector(
  ".section-about .text-box-circle .text-label"
);
if (textBoxCircle) {
  textBoxCircle.innerHTML = textBoxCircle.innerText
    .split("")
    .map(function (_char2, i) {
...
if (document.querySelector(".team-detail-block")) {
  if (selectedMemberInfo !== null) {
    if (
      document.querySelector(".member-img img") &&
      document.querySelector(".member-position") &&
      document.querySelector(".member-name")
    ) {
      document.querySelector(".member-name").textContent =
        selectedMemberInfo.name;
      document.querySelector(".member-position").textContent =
  ...
  caseStudiesItems.forEach(function (caseStudiesItem) {
    caseStudiesItem.addEventListener("click", function () {
      ...
      localStorage.setItem(
        "selectedCaseStudies",
        JSON.stringify(caseStudiesInfor)
      );
    });
  });
}
...
var selectedCaseStudiesInfo = JSON.parse(
  localStorage.getItem("selectedCaseStudies")
);
...
if (document.querySelector(".case-studies-detail-block")) {
  if (selectedCaseStudiesInfo !== null) {
    if (
      document.querySelector(".heading-content .bg-img img") &&
      document.querySelector(".category") &&
      document.querySelector(".title")
    ) {
      document.querySelector(".title").textContent =
        selectedCaseStudiesInfo.title;
      document.querySelector(".category").textContent =
        selectedCaseStudiesInfo.category;
      document.querySelector(".heading-content .bg-img img").src =
        selectedCaseStudiesInfo.img;
    }
  }
}
...
if (blogItems) {
  blogItems.forEach(function (blogItem) {
    blogItem.addEventListener("click", function () {
      ...
      if (
        blogItem.querySelector(".category") ||
        blogItem.querySelector(".title") ||
        blogItem.querySelector(".date")
      ) {
        var blogInfor = {
...
var comments = document.querySelectorAll(
  ".blog-detail-page .blog-comment .comment-item .like"
);
if (comments) {
...
var showReplyBtn = document.querySelectorAll(
  ".blog-detail-page .blog-comment .comment-item .cmt"
);
var listReply = document.querySelectorAll(
  ".blog-detail-page .blog-comment .list-reply"
);
if (showReplyBtn) {
...
if (document.querySelector(".product-detail-heading")) {
  ...
  if (selectedProductInfo !== null) {
    if (
      ...
      document.querySelector(".bg-img img")
    ) {
...
var confirmDeleteModalContainer = document.querySelector(
  ".confirm-delete-modal-container"
);
var cancelConfirmDelete = document.querySelector(
  ".confirm-delete-modal .cancel"
);
...
var showProductToCart = function showProductToCart() {
  if (cartModal) {
    var listProductModalCart = document.querySelector(
    ...
    if (cartStore && cartStore.length > 0) {
      ...
      cartStore.forEach(function (list) {
        ...
        productItem.innerHTML =
          '\n                    <div class="main-item">\n                        <img class="item-img" src="'
            .concat(list.prdImg, '" alt="')
            .concat(
              list.prdName,
              '"/>\n                        <div class="item-infor"> \n                            <div class="item-name text-button-small">'
            )
            .concat(
              list.prdName,
      ...
      document.querySelector(
        ".cart-modal .footer-heading .heading-price"
      ).innerHTML = "$".concat(totalModalCart, ".00");
    } else {
      listProductModalCart.innerHTML =
        '<div class="text-button pt-16">No product in your shopping cart!</div>';
      document.querySelector(
        ".cart-modal .footer-heading .heading-price"
      ).innerHTML = "$0";
    }
...
var reduceNumberCarts = document.querySelectorAll(
  ".list .item .quantity-block .ph-minus"
);
var increaseNumberCarts = document.querySelectorAll(
  ".list .item .quantity-block .ph-plus"
);
...
if (addToCartBtn) {
  ...
  addToCartBtn.addEventListener("click", function () {
    ...
    var prdQuantity = document.querySelector(
      ".prd-quantity .quantity-block span"
    ).textContent;
    ...
    var totalPrdPrice =
      Number(prdQuantity) * parseFloat(prdPrice.replace(/[^0-9.]/g, ""));
...
var showListProductInCart = function showListProductInCart() {
  if (document.querySelector(".cart-block")) {
    ...
    if (cartStore && cartStore.length > 0) {
      cartStore.forEach(function (list) {
        ...
        productItem.innerHTML =
          '\n                    <div class="row">\n                        <div class="col-6">\n                            <div class="flex-item-center"> \n                                <div class="bg-img pr-28 pl-28 flex-center border-outline bora-8">\n                                    <img class="w-100" src="'
            ...
            .concat(
              list.prdName,
              '"/>\n                                </div>\n                                <div class="name text-button pl-16">'
            )
            .concat(
              list.prdName,
            ...
            .concat(
              ...
              '\n                                <span class="text-button quantity">'
            )
            .concat(
              list.prdQuantity,
              '</span>\n                                <i class="ph ph-plus"></i>\n                            </div>\n                        </div>\n                        <div class="col-2 flex-center">\n                            <div class="text-button total">$'
            )
            .concat(
              list.totalPrdPrice,
      ...
      listProduct.innerHTML =
        '<div class="text-button mt-16">No product in your shopping cart!</div>';
      document.querySelector(".discount-block span.discount").innerHTML = "0";
      document.querySelector(
        ".discount-block >div:last-child span:first-child"
      ).innerHTML = "$";
...
var handleShoppingCartPage = function handleShoppingCartPage() {
  if (document.querySelector(".cart-block")) {
    ...
    var totalPricePrds = document.querySelector(
      ".checkout-block span.total-product"
    );
    ...
    var totalPriceCart = document.querySelector(
      ".total-cart-block span.total-cart"
    );
    var discountPrice = document.querySelector(".discount-block span.discount");
    totalPriceCart.innerHTML =
      Number(totalPricePrds.innerHTML) - Number(discountPrice.innerHTML);

    // Handle price heading (Buy ... more to get Freeship)
    // You can change to any number
    var totalPriceToFreeship = 1000;
    var priceToFreeShip = document.querySelector(
      ".cart-block .heading span.price"
    );
    priceToFreeShip.innerHTML =
      Number(totalPriceToFreeship) - Number(totalPricePrds.innerHTML);
    ...
    var percentProgress =
      (Number(priceToFreeShip.innerHTML) / Number(totalPriceToFreeship)) * 100;
...
if (document.querySelector(".cart-block")) {
  ...
  var increaseQuantity = document.querySelectorAll(
    ".item .quantity-block .ph-plus"
  );
  var reduceQuantity = document.querySelectorAll(
    ".item .quantity-block .ph-minus"
  );
  ...
  increaseQuantity.forEach(function (increaseIcon) {
    increaseIcon.addEventListener("click", function () {
      ...
      totalPricePrdItem.innerHTML = "$".concat(
        parseFloat(pricePrd.replace(/[^0-9.]/g, "")) * quantity,
        ".00"
      );
      handleShoppingCartPage();
    });
  ...
  _productItems.forEach(function (item) {
    ...
    if (deleteIcon) {
      deleteIcon.addEventListener("click", function () {
        ...
        var confirmDeleteBtn = document.querySelector(
...
checkoutBtn.forEach(function (btn) {
  btn.addEventListener("click", function () {
    ...
    productItems.forEach(function (item) {
      ...
      var prdQuantity = item.querySelector(
        ".quantity-block .quantity"
      ).textContent;
      var totalPrdPrice = item.querySelector(".total").textContent;
      var totalPricePrdToCheckout =
        document.querySelector(".total-product").textContent;
      var discount = document.querySelector(".discount").textContent;
      var totalPriceCartToCheckout =
...
var formLoginHeading = document.querySelector(
  ".checkout-block-main .form-login-block"
);
var loginHeading = document.querySelector(
  ".checkout-block-main .login .left span.text-button"
);
var iconDownHeading = document.querySelector(
  ".checkout-block-main .login .right i"
);
if (loginHeading) {
...
var paymentCheckbox = document.querySelectorAll(
...
if (document.querySelector(".checkout-block-main")) {
  var listProductCheckout = document.querySelector(
    ".checkout-block-main .checkout-block .list-product-checkout"
  );
    ...
    checkoutProduct.forEach(function (list) {
      ...
      productItem.innerHTML =
        '\n                <div class="left flex-item-center gap-8">\n                    <div class="bg-img flex-center border-outline">\n                        <img src="'
          ...
          .concat(
            list.prdName,
            '</span>\n                </div>\n                <div class="right flex-item-center text-end"> \n                    <div class="quantity text-button">'
          )
          .concat(
            list.prdQuantity,
            ' x \n                    </div>\n                    <div class="text-button pl-4 price">'
          )
          .concat(list.prdPrice, "</div>\n            </div>\n            ");
      listProductCheckout.appendChild(productItem);

      // Set total money cart
      document.querySelector(".total-block .total-product").innerHTML =
        "$".concat(list.totalAllPrdPrice, ".00");
      document.querySelector(".discount-block span.discount").innerHTML =
        list.discount;
      document.querySelector(".total-cart-block .total-cart").innerHTML =
        "$".concat(list.totalCartPrice, ".00");
    });
  } else {
    listProductCheckout.innerHTML =
      '<div class="text-button mt-24">No product in your shopping cart!</div>';
    document.querySelector(".discount-block span.discount").innerHTML = "0";
  }
}
